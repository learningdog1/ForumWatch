 ...
 *   不回复）；推送配置里的主 Chat ID 隐含允许，无需重复填。
  ...
  return (
    <section className="card">
      <div className="card-head">
        ...
        <span className="card-title-aux">{rc.enabled ? '已启用' : '关闭'}</span>
      </div>
      <Field
        label="开关"
        hint={
          <span>
            ...
            Telegram 推送通道）。可用指令：{REMOTE_COMMANDS.join(' / ')}
      ...
      <Field
        ...
        hint={
          <span>
            ...
            推送通道里配置的<strong>主 Chat ID 隐含允许</strong>，无需重复填。
